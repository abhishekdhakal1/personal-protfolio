...
export function AboutSection() {
  return (
    <section id="about" className="min-h-screen py-20 px-6 bg-slate-950 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-slate-300 max-w-3xl mx-auto text-lg">
            I'm a third-year engineering student passionate about the intersection of hardware and software. 
            Currently exploring UI/UX and frontend development while working towards becoming a full-stack developer. 
            My mission is to bridge the gap between physical and digital systems.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                <div className="relative p-8 bg-slate-900/50 border border-slate-800 rounded-2xl backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300">
                  ...
                  <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${skill.color} p-0.5 mb-6`}>
        ...
        >
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            {[
              { year: "Year 1", title: "Electronics Fundamentals", desc: "Building strong foundation in circuit design and digital systems" },
              { year: "Year 2", title: "Full Stack Development", desc: "Mastered UI/UX, frontend, and some fundamentals of backend." },
              { year: "Year 3", title: "Communication Systems", desc: "Currently diving into filter design, embedded systems and wireless technologies" }
            ].map((item, index) => (
              <motion.div
                key={item.year}
